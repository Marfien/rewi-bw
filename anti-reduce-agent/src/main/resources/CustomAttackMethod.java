public void attack(Entity $1) {
  System.out.println("Called bytecode replaced attack method");
  if ($1.aD()) {
    if (!$1.l($0)) {
      float attackDamage = (float) $0.getAttributeInstance(net.minecraft.server.v1_8_R3.GenericAttributes.ATTACK_DAMAGE)
          .getValue();
      float sharpnessModifier = $1 instanceof net.minecraft.server.v1_8_R3.EntityLiving
          ? net.minecraft.server.v1_8_R3.EnchantmentManager.a($0.bA(),
              ((net.minecraft.server.v1_8_R3.EntityLiving) $1).getMonsterType())
          : net.minecraft.server.v1_8_R3.EnchantmentManager.a($0.bA(),
              net.minecraft.server.v1_8_R3.EnumMonsterType.UNDEFINED);
      ...
      if (attackDamage > 0.0F || sharpnessModifier > 0.0F) {
        boolean isJumpAttack = $0.fallDistance > 0.0F && !$0.onGround && !$0.k_() && !$0.V()
            && !$0.hasEffect(net.minecraft.server.v1_8_R3.MobEffectList.BLINDNESS) && $0.vehicle == null
            && $1 instanceof net.minecraft.server.v1_8_R3.EntityLiving;
        ...
        int fireAspectEnchantmentLevel = net.minecraft.server.v1_8_R3.EnchantmentManager
            .getFireAspectEnchantmentLevel($0);

        if ($1 instanceof net.minecraft.server.v1_8_R3.EntityLiving && fireAspectEnchantmentLevel > 0
            && !$1.isBurning()) {
          // CraftBukkit start - Call a combust event when somebody hits with a fire
          // enchanted item
          org.bukkit.event.entity.EntityCombustByEntityEvent combustEvent = new org.bukkit.event.entity.EntityCombustByEntityEvent(
              $0.getBukkitEntity(),
              $1.getBukkitEntity(), 1);
        ...
        boolean entityAttackResult = $1.damageEntity(net.minecraft.server.v1_8_R3.DamageSource.playerAttack($0),
            attackDamage);

        if (entityAttackResult) {
          if (knockbackModifire > 0) {
            $1.g(
                (double) (-net.minecraft.server.v1_8_R3.MathHelper.sin($0.yaw * 3.1415927F / 180.0F)
                    * (float) knockbackModifire * 0.5F),
                0.1D,
                (double) (net.minecraft.server.v1_8_R3.MathHelper.cos($0.yaw * 3.1415927F / 180.0F)
                    * (float) knockbackModifire * 0.5F));
          ...
          if ($1 instanceof net.minecraft.server.v1_8_R3.EntityPlayer && $1.velocityChanged) {
            ...
            org.bukkit.event.player.PlayerVelocityEvent event = new org.bukkit.event.player.PlayerVelocityEvent(player,
                velocity.clone());
            ...
            if (!cancelled) {
              ((net.minecraft.server.v1_8_R3.EntityPlayer) $1).playerConnection
                  .sendPacket(new net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity($1));
          ...
          if ($1 instanceof net.minecraft.server.v1_8_R3.EntityLiving) {
            ...
            if (fireAspectEnchantmentLevel > 0) {
              ...
              // enchanted item
              org.bukkit.event.entity.EntityCombustByEntityEvent combustEvent = new org.bukkit.event.entity.EntityCombustByEntityEvent(
                  $0.getBukkitEntity(), $1.getBukkitEntity(),
